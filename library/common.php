...
{
	if (!isset($_SESSION['dentadepot_error'])) {
		$_SESSION['dentadepot_error'] = array();
	}
	
	$_SESSION['dentadepot_error'][] = $errorMessage;
...
{
	if (isset($_SESSION['dentadepot_error']) && count($_SESSION['dentadepot_error'])) {
		$numError = count($_SESSION['dentadepot_error']);
		
		echo '<table id="errorMessage" width="550" align="center" cellpadding="20" cellspacing="0"><tr><td>';
		for ($i = 0; $i < $numError; $i++) {
			echo '&#8226; ' . $_SESSION['dentadepot_error'][$i] . "<br>\r\n";
		}
		echo '</td></tr></table>';
