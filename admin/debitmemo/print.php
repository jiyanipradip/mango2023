...
// get ordered items
//echo samir
$sql = "SELECT * from debitmemo oi, productmast p  where oi.Prodid = p.PordId  AND oi.memono = '$memono' AND oi.CustId  = $oid
		AND oi.Prodid != 1
...
$sqlx = "SELECT * from vendormast where vendorid = '$oid'
		 ";
...
?>
	...
	{
	$sql333 = "select * from debitmemomaster  where memono= $memono";
