	...
	while($row = dbFetchAssoc($result)) {
		...
		?>
			<tr>
				...
				<a href="javascript:getback('<? echo $ProdSKU; ?>','<? echo $catId; ?>','<? echo $memono; ?>');"><? echo $memono; ?><? echo $ProdName; ?></a> &nbsp;</td><td><? echo $PordId; ?> &nbsp;</td><td><? echo $ProdSKU; ?> &nbsp;</td><td><input type="hidden" name="grname" id="grname" value="<? echo $PordId; ?>">
