...
//echo $barcode2;
							...
							$sqlforno="select * from debitmemomaster order by memono DESC";
...
}else
{
	...
	if(mysql_num_rows($result) == 1)
	{
		...
		$sqlinvno="select memono from debitmemomaster ORDER BY memono DESC";
...
if(isset($generate))
{
$sqlgeneratesrno="insert into debitmemomaster(`sid`) VALUES ('sid')";
...
//	$sql2 = " AND  p.CatagoryId = '$catId'";
	//$queryString = "catId='$catId'";
		$sid = session_id();
		$sql2="select * from debitmemo where sessid = '$sid' AND Prodid = '1' AND CustId = '$catId'";
		$result2=mysql_query($sql2);
		if(mysql_num_rows($result2) == 0)
		{
		$sql1="insert into debitmemo(`sessid`,`Prodid`,`CustId`) values('$sid',1,'$catId')";
		//echo $sql1;
...
<?
if(isset($sid)){
$sql = "select memono from debitmemo where custid='$catId' AND sessid='$sid'";
$result=mysql_query($sql);
