...
if($_POST['addbarcode'])
{
	...
	function getback(barcode,catId,srno1)
	{
	if(barcode == '')
	{
	...
	{
	window.location.href='refresh_carecredit1.php?catId=' + catId + '&barcode=' + barcode + '&srno1=' + srno1;
	}	
	}
	...
	while($row = dbFetchAssoc($result)) {
		...
		?>
			<tr>
				...
				<a href="javascript:getback('<? echo $ProdSKU; ?>','<? echo $catId; ?>','<? echo $srno1; ?>');"><? echo $ProdName; ?></a> &nbsp;</td><td><? echo $PordId; ?> &nbsp;</td><td><? echo $ProdSKU; ?> &nbsp;</td><td><input type="hidden" name="grname" id="grname" value="<? echo $PordId; ?>">
