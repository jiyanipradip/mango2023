...
?>
  ...
  <td><?php echo $PordId; ?></td>
   ...
   <td width="70" align="center"><a href="javascript:modifyProduct('<?php echo stripslashes($PordId); ?>','<?php echo stripslashes($Categorymain);?>','<?php echo stripslashes($CatagoryId); ?>');">Modify</a></td>
   <td width="70" align="center"><a href="javascript:deleteProduct('<?php echo stripslashes($PordId); ?>','<?php echo stripslashes($Categorymain);?>','<?php echo stripslashes($CatagoryId); ?>');">Delete</a></td>
  </tr>
  <?php
	} // end while
?>
...
?>
  ...
  <tr> 
   <td colspan="5" align="right"><input name="btnAddProduct" type="button" id="btnAddProduct" value="Add Product" onClick="addProduct('<?php echo $catId; ?>','<?php echo $ccatId; ?>')"></td>
  </tr>
 </table>
 <p>&nbsp;</p>
</form>