...
if((isset($_POST['barcodeentry'])) || (isset($barcode2)))
 {
	...
	if(mysql_num_rows($result) == 1)
	{
		...
		$sqlinvno="select invoiceno from invoicemaster where invoiceno=$invno";
       ...
       Add New</a></td></tr>
			<tr>
   		  ...
   		  <table class="ddepot-blueborder">
				...
				<td width=50%>
   		  <table class="ddepot-blueborder" style="display:none;">
                        	<tr>
...
?>
    <tr class="content"> 
        ...
        <input type="text" maxsizze="6" size="6" name="barcode" id="barcode"  value="<? echo $Prodid; ?>"  <? /* onBlur="viewProduct21(this,'<? echo $oid; ?>','<? echo $srno; ?>','<? echo $sid; ?>')" */ ?> style="text-align:right"></td>
        <td valign="top"><input type="text" <? if($Prodid != 1) { ?> value="<?php echo $Prodid; ?>" <? } ?> maxsizze="6" size="6" <? /*onBlur="enterqty7(this,'<? echo $srno; ?>','<? echo $catId;?>','<? echo $barcode; ?>','<? echo $sid;?>');" */ ?> name="prod1" id="prod1" style="text-align:right"></td>
        <td valign="top"><input type="text" name="proddesc<? echo $srno; ?>" id="proddesc<? echo $srno; ?>" value="<? echo $Proddesc; ?>"> &nbsp;</td>
        <td valign="top">
		
		<input type="text" <? if($Prodid  != 1) { ?>  value="<? echo $qty; ?>" <? } ?> name="qtytext<? echo $srno; ?>" maxsizze="3" size="3" id="qtytext<? echo $srno; ?>"
          <? /* onblur="enterqtymodify(this,'<? echo $srno; ?>','<? echo $catId;?>','<? echo $ProdSKU; ?>','<? echo $sid; ?>');" */ ?> style="text-align:right"/></td>
          <td valign="top">
		
		<input type="text" <? if($Prodid  != 1) { ?>  value="<? echo $backorder; ?>" <? } ?> name="backorder<? echo $srno; ?>" maxsizze="3" size="3" id="backorder<? echo $srno; ?>"
          <? /* onblur="enterqtymodify(this,'<? echo $srno; ?>','<? echo $catId;?>','<? echo $ProdSKU; ?>','<? echo $sid; ?>');" */ ?> style="text-align:right"/></td>
...
?>
    ...
    <?
if(isset($invno)){
$sqlyy = "select invoiceno from invoice where invoiceno='$invno'";
