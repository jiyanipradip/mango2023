	...
	?>
     <tr class="content"> 
       <td><?php  echo "$ProdName"; ?>&nbsp;</td>
          <?php /*<td align="right"><?php  echo ($orderd_qty); $orderd_qty1=$orderd_qty1+$orderd_qty; ?><br>BOX&nbsp;</td> */?>
          <td align="right"><?php  echo ($orderd_qty); $orderd_qty1 = $orderd_qty1 + ROUND($DiscQty * $orderd_qty,0); ?><br>BOX&nbsp;</td>
...
?>
     <tr class="content"> 
       ...
       <td colspan="3" align="right"><strong>Discount</strong>&nbsp;</td>
		  ...
		  $data_dis = mysql_fetch_assoc($res_dis);
            ...
            if($discount>0){ echo "-$".number_format($discount,2); }else{ echo "$".number_format($discount,2); }
        
           // $Order_Tot = $Order_Tot - $discount;
		  ?>&nbsp;
           </td>
      </tr>
     <tr class="content"> 
     ...
     <tr class="content"> 
       <td colspan="3" align="right"><strong>Total</strong>&nbsp;</td>
          <td align="right">$<?php  echo number_format(($Prod_Tot + $Ship_Tot - $discount),2); //echo number_format(($Order_Tot),2) ; ?>&nbsp;</td>
      </tr>
   </table></td>
     ...
     <tr><td align="left">
         ...
         <?php  echo $Adr1; ?> <br><?php  echo $Adr2; ?><br>
          ...
          <?php  echo $Country; ?><br><?php echo $Phone;?>
          ...
          <?php  echo $Ship_Country; ?>  <br><?php echo $Ship_Phone; ?>
           <br><?php echo $Ship_Email_Id; ?> </td>
          </tr></table></td>
          <td valign="top">
