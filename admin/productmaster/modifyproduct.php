...
$sql = "SELECT p.PordId, p.CatagoryId, CatagoryName,p.ProdName,p.pd_thumbnail
...
{
	window.location.href = 'index.php?ccatId='+parentid+'&catId='+childid;
}
</script>
<form action="processProduct.php?action=modifyProduct&productId=<?php echo $productId; ?>" method="post" enctype="multipart/form-data" name="frmAddProduct" id="frmAddProduct">
 <table width="650px" border="0" align="center" cellpadding="5" cellspacing="1" class="ddepot-blueborder">
 <tr>
   <td colspan="2" class="hdbg">Modify Product Master</td>
 </tr>
   ...
   <td class="content"> <input name="txtid" type="text" class="box" id="txtid" size="50" maxlength="100" value="<?php echo stripslashes($PordId); ?>">
   	<input type="hidden" name="cboCategory2hidden" id="cboCategory2hidden" value="<? echo $Categorymain; ?>">
<input type="hidden" name="cboCategoryhidden" id="cboCategoryhidden" value="<? echo $SubCatId; ?>">
</td>
  </tr>
  <tr> 
...
?>    
  ...
  <input name="btnModifyProduct" type="submit" id="btnModifyProduct" value="Modify Product" onClick="checkAddProductForm();">
  &nbsp;&nbsp;<input name="btnCancel" type="button" id="btnCancel" value="Cancel" onClick="cancelclick('<? echo $parentId; ?>','<? echo $ChildId; ?>')">  
 </td></tr>
 </table>
</form>