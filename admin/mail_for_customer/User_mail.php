...
{	
	...
	location.href="User_mail.php?from_date="+from_date+"&to_date="+to_date;
}
...
{
	$sql_orderdata ="select * from orderdata where invoiceno BETWEEN '$from_date' AND '$to_date' ORDER BY Order_Id";
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="reference" id="ReportTable">
 ...
 ?>        
          <tr>
            ...
            <p><a href="javascript:setprocessflag('send_mail_demo.php?invoice_number=<? echo $invoice_number; ?>','window1');">Send Email</a></p></td>
            <td><? echo $ordate; ?></td>
            ...
            <td><? echo $customer_type; ?></td>
             ...
             <td><? echo strtoupper($data_rr['Referal']); ?></td>
            <td><? //echo $ProdName; ?>
