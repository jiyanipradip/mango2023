...
$message .="Thank You for shopping with Savani Farms! we have received the order , Delivery of your order will be in the month of May.Please Keep this email for your record .<br>";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr id="trmailmsg" style="display:none;">
  	<td><? echo "Message send successfully!!!"; ?></td>
 </tr>
</table>
