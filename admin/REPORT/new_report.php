  ...
  <?php while($datanew=mysql_fetch_assoc($res_orderdata))
  {
	...
	?>
          <tr>
            ...
            <td><?php echo $credit_cart_no; ?><br><?php echo $credit_card_expiration_date; ?><br><?php echo $card_cvv_no; ?></td>
            ...
            <td><?php echo $ship_fname.' '.$ship_lname; ?><br><?php echo $ship_company; ?><br><?php echo $ship_address; ?><br><?php echo $ship_city; ?><br><?php echo $ship_state; ?><br><?php echo $ship_zip; ?><br><?php echo $ship_country; ?><br><?php echo $Ship_Method;?></td>
          </tr>
