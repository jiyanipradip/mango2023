...
if($from_date!='' && $to_date!='')
{
	...
	$jp = 0;
	  ...
	  while($datanew=mysql_fetch_assoc($res_orderdata))
      {
            ...
            $Coupon_code=strtoupper(substr(trim($datanew['Coupon_code']),0,60));
          ...
          if($Order_rate=='175')
          {
             $netorder = ($strboxxx - $cancel_order) * 5;  
            //echo $netorder."===".$Order_rate."<br />";
          }
          else
          {
			...
			//echo $netorder."===".$Order_rate."===".$orderd_qty."<br />";
            //echo $strboxxx."===".$cancel_order."===".$Order_rate."<br />";
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="reference" id="ReportTable">
  <tr>
    <td bgcolor="#FFFF00"><strong>Sr. No</strong></td>
	<td bgcolor="#FFFF00"><strong>Order</strong></td>	
    <td bgcolor="#FFFF00"><strong>Date</strong></td>
    <td bgcolor="#FFFF00"><strong>Name</strong></td>
    <td bgcolor="#FFFF00"><strong>Order Status</strong></td>
    <td bgcolor="#FFFF00"><strong>Number of Boxes</strong></td>
    <td bgcolor="#CC6666"><strong>Cancelled Boxes</strong></td>
    <td bgcolor="#33CC66"><strong>Net Orders</strong></td>
	<td bgcolor="#FFFF00"><strong>Net Charges for Mangoes</strong></td>
	<td bgcolor="#FFFF00"><strong>Shipping Charged</strong></td>
    <td bgcolor="#FFFF00"><strong>Discount</strong></td>
	<td bgcolor="#FFFF00"><strong>Fedex Shipping Charges</strong></td>
	<td bgcolor="#FFFF00"><strong>Billed Amount</strong></td>
	<td bgcolor="#FFFF00"><strong>Received Amount</strong></td>
	<td bgcolor="#FFFF00"><strong>Tracking No</strong></td>
    <td bgcolor="#FFFF00"><strong>Shipping Name</strong></td>
	<td bgcolor="#FFFF00"><strong>Shipping Address</strong></td>
    <td bgcolor="#FFFF00"><strong>Billing Address</strong></td>
	<!--<td bgcolor="#FFFF00"><strong>Shipping City</strong></td>
	<td bgcolor="#FFFF00"><strong>Shipping State</strong></td>
	<td bgcolor="#FFFF00"><strong>Shipping Zip Code</strong></td>
	<td bgcolor="#FFFF00"><strong>Shipping Country</strong></td>-->
    <td bgcolor="#FFFF00"><strong>Coupon Code.</strong></td>
	<td bgcolor="#FFFF00"><strong>Phone No.</strong></td>
	<td bgcolor="#FFFF00"><strong>Shipping Method</strong></td>
  </tr>
  <?php
  if(count($data)>0)
  {
  ...
  ?>
          <tr bgcolor="<?php echo $bgcolor;?>">
			...
			<td><?php echo $row["Shipping Address"].' '.$row["Shipping City"].' '.$row["Shipping State"].'-'.$row["Shipping Zip Code"].' '.$row["Shipping Country"]; ?></td>
            <td><?php echo $row["Billing Address"].' '.$row["Billing City"].' '.$row["Billing State"].'-'.$row["Billing Zip Code"].' '.$row["Billing Country"]; ?></td>
            ...
            <td><?php echo $row["Coupon Code"]; ?></td>  
