...
{	
	...
	location.href="invoice_report.php?from_date="+from_date+"&to_date="+to_date;
}
</script>
<style>
.fixtbl{
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="reference" id="ReportTable">
  <tr>
    ...
    <td bgcolor="#f0f0f0">Payment Method</td>
    <td bgcolor="#f0f0f0">Credit Card Number</td>
    <td bgcolor="#f0f0f0">Credit Card Expiration Date</td>
    <td bgcolor="#f0f0f0">Card Code</td>
    <td bgcolor="#f0f0f0">Customer Type</td>
    ...
    <td bgcolor="#f0f0f0">Shipping Country</td>
  </tr>
  <?
  while($datanew=mysql_fetch_assoc($res_orderdata))
  {
	...
	?>
          <tr bgcolor="<?php echo $bgcolor;?>">
            ...
            <td><? echo $credit_cart_no; ?></td>
            <td><? echo $credit_card_expiration_date; ?></td>
            <td><? echo $card_cvv_no; ?></td>
