...
{	
	...
	location.href="zipcode_list.php?from_date="+from_date+"&to_date="+to_date;
}
</script>
<style>
.fixtbl{
...
<table width="100%" border="1" cellspacing="5" cellpadding="5" class="reference" align="center">
  <tr>
  	<td align="center" bgcolor="#f0f0f0"><strong>SAVANIFARM ZIPCODE WISE REPORT</strong></td>
  </tr>
  <tr>
  	<td align="center">
...
{
	$sql_orderdata ="select * from orderdata where invoiceno BETWEEN '$from_date' AND '$to_date' ORDER BY Order_Id DESC";
