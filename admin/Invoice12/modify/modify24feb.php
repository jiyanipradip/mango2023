...
?>
<form name="exampleForm" action="modify/upload_file.php?catId=<? echo $catId; ?>&num=<? echo $numItem; ?>&invoiceno=
<? echo $invno; ?>&srno=<? echo $srno; ?>" method="post" enctype="multipart/form-data">
    <tr class="content"> 
   		<td valign="top">
     
        
        <input type="text" maxsizze="6" size="6" name="barcode" id="barcode" <? if(isset($barcode)) { if($ProdSKU != 1) { ?> value="<? echo $ProdSKU; ?>" <? } }?> onBlur="viewProduct21(this,'<? echo $oid; ?>','<? echo $srno; ?>','<? echo $sid; ?>')" style="text-align:right"></td>
...
?> <a href="../Invoice/print.php?oid=<? echo $catId; ?>&sis=<? echo $popat['sessid'];  ?>&invoiceno=<? echo $invno; ?>" target="_blank">PRINT</a><? } ?>
   | <a href="javascript: deleteCategoryfordelete('<? echo $catId;?>',<? echo $invno; ?>);">DELETE&nbsp;</a></td></tr>
    <tr><td colspan="9" align="center"><input type="submit" value="SAVE"> </td></tr>
</table>
<? 
}
