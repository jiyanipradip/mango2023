...
<body onLoad="window.print()"><table border="0" align="left" width="665"><tr><td>
 		...
 		<table align="right">
        	<tr><td><h1>Invoice </h1>
            			<table border="0" class="maintable" cellpadding="0" cellspacing="0">
                            ...
                            <tr><td class="leftbtm2"><? echo date("Y-m-d"); ?></td><td >&nbsp;<? echo $invoiceno; ?><input type = "hidden" name="oid" id="oid" value="<? echo $oid; ?>"></td></tr>
                        </table>
            </td></tr>
...
<br>
  ...
  <table width="665" border="0" cellpadding="0" cellspacing="0" align="right" class="maintable">
...
<table width="665" align="center" border="0" cellpadding="0" cellspacing="0" class="maintable">

    <tr align="center" class="label"> 
          <td width="64" class="leftbtm" >Quantity&nbsp;</td>
        <td width="66" class="leftbtm">Item Code&nbsp;</td>
      <td width="281" class="leftbtm">Description&nbsp;</td>
      <td width="91" class="leftbtm">Sales Price&nbsp;</td>
      <? /*
      <td width="30">Net Amt&nbsp;</td>
      <td width="42">Tax %&nbsp;</td>
      */ ?>
	  <td width="87" class="btmbrd">Amount&nbsp;</td>
...
?>
    <tr height="10"> 
            <td align="right" class="rightbrd"><? echo $qty; ?></td>

        <td class="rightbrd"><?php echo $Prodid; ?>&nbsp;</td>
        <td align="left" class="rightbrd"><? echo $ProdName; ?>&nbsp;</td>
        <td align="right" class="rightbrd"><?php echo number_format(($Prodprice),2); ?></td>
        <? /*
...
?><? 	if((isset($numItem)) && ($numItem < 26)) { for($k=0;$k<(26 - $numItem);$k++) {?>
    <tr><td class="rightbrd">&nbsp;</td><td class="rightbrd">&nbsp;</td><td class="rightbrd">&nbsp;</td><td class="rightbrd">&nbsp;</td><td>&nbsp;</td></tr><? }} ?><td colspan="3" class="topbrd">Customer Service Contact :<?  if(isset($contact)) { ?><? echo $_GET['contact']; ?><? } ?></td>
   ...
   <tr> 
    ...
    <tr> 
        <td colspan="4" align="right" class="rightbrd">    
Shipping&nbsp;</td>
    ...
    <tr><td colspan="4" align="center" class="rightbrd"></td><td  class="rightbrd"></td></tr>
  </table>
  <table align="center">
  	<tr><td>&nbsp;</td></tr>
  	<tr>
